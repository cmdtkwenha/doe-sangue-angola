const schemaContract = {
  ...
  donor_responses: ["id", "donor_id", "hospital_id", "blood_request_id", "created_at", "eta_minutes", "confirmation_pin", "status", "accepted_at", "arrived_at", "pin_validated_at", "cancelled_at", "completed_at", "donation_completed_at", "pin_expires_at", "pin_locked_until", "failed_pin_attempts", "reward_accepted_at", "reward_arrived_at", "reward_completed_at"],
  donors: ["id", "user_id", "blood_type", "province", "municipality", "available", "last_donation", "points", "preferred_hospital_id", "created_at", "reliability_score", "response_speed_minutes", "next_eligible_donation_date", "consent_accepted_at", "consent_version", "privacy_policy_version", "medical_disclaimer_version", "emergency_contact_name", "emergency_contact_phone", "gender", "birth_date", "latitude", "longitude", "location_permission_status", "last_donation_date"],
  ...
  profiles: ["id", "auth_user_id", "role", "linked_entity_id", "name", "email", "created_at"],
  provinces: ["id", "name"],
