const schemaContract = {
  ...
  hospitals: ["id", "name", "province", "municipality", "verified", "verification_status", "rejection_reason", "capacity", "contact", "created_at", "address", "email", "facility_type", "license_number", "phone", "latitude", "longitude", "main_contact_person", "operational_phone", "operational_email", "emergency_contact", "operating_hours"],
